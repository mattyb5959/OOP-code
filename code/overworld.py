...
from sprites import AnimatedSprite, Sprite, Node, Icon, PathSprite
...
class Overworld:
    ...
    #---------------------------------------------- PLAYER LEVEL SELECTION AND PLAYER---------------------------------
    ...
    def input(self):
        ...
        if self.current_node and not self.icon.path:
            if (key_pressed[pygame.K_w] or key_pressed[pygame.K_UP]) and self.current_node.can_move('up'): 
                self.move('up')
            if (key_pressed[pygame.K_DOWN] or key_pressed[pygame.K_s]) and self.current_node.can_move('down'):
                self.move('down')

            if (key_pressed[pygame.K_a] or key_pressed[pygame.K_LEFT]) and self.current_node.can_move('left'): 
                self.move('left')
            if (key_pressed[pygame.K_d] or key_pressed[pygame.K_RIGHT]) and self.current_node.can_move('right'):
                self.move('right')
                #print('can move down')
